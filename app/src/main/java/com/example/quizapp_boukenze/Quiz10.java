    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bNext.setOnClickListener(v -> {
            ...
            if (selectedId == -1) {
                ...
                if (selectedId == R.id.rb1) sGESI++;
                else if (selectedId == R.id.rb2) sGC++;
                else if (selectedId == R.id.rb3) sGI++;
                else if (selectedId == R.id.rb4) sIIR++; // Changed to IIR or GF as it is virtual

                Intent intentNext = new Intent(Quiz10.this, Quiz11.class);
