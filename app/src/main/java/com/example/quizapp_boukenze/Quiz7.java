...
public class Quiz7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bNext.setOnClickListener(v -> {
            ...
            if (selectedId == -1) {
                Toast.makeText(getApplicationContext(), "Merci de répondre !", Toast.LENGTH_SHORT).show();
            } else {
                if (selectedId == R.id.rb1) sIAII++;
                else if (selectedId == R.id.rb2) sGESI++;
                else if (selectedId == R.id.rb3) sGC++;
                else if (selectedId == R.id.rb4) sGF++;

                Intent intentNext = new Intent(Quiz7.this, Quiz8.class);
