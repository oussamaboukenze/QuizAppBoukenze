...
public class Quiz14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bNext.setOnClickListener(v -> {
            ...
            if (selectedId == -1) {
                Toast.makeText(getApplicationContext(), "Diagnostic en cours, merci de répondre.", Toast.LENGTH_SHORT).show();
            } else {
                if (selectedId == R.id.rb1) sIIR++;
                else if (selectedId == R.id.rb2) sGC++;
                else if (selectedId == R.id.rb3) sGI++;
                else if (selectedId == R.id.rb4) sGESI++;

                Intent intentNext = new Intent(Quiz14.this, Quiz15.class);
